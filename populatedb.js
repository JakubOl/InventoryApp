...
function itemCreate(name, category, price, description, inStock, cb) {
...
function createCategories(cb) {
  async.parallel(
    [
      function (callback) {
        categoryCreate("Amino Acids", callback);
      },
      function (callback) {
        categoryCreate("Carbo", callback);
      },
      function (callback) {
        categoryCreate("Creatines", callback);
      },
      function (callback) {
        categoryCreate("Diet food", callback);
      },
      function (callback) {
        categoryCreate("Energy and Concentration", callback);
      },
      function (callback) {
        categoryCreate("Fat burners", callback);
      },
      function (callback) {
        categoryCreate("Intra-workout", callback);
      },
      function (callback) {
        categoryCreate("Mass gainers", callback);
      },
      function (callback) {
        categoryCreate("Pre-workouts", callback);
      },
      function (callback) {
        categoryCreate("Proteins", callback);
      },
      function (callback) {
        categoryCreate("Testosterone boosters", callback);
      },
      function (callback) {
        categoryCreate("Vitamins & Minerals", callback);
      },
    ],
    cb
  );
...
async.series(
  ...
  function (err, results) {
    if (err) {
      ...
      console.log("Items: " + bookinstances);
    }
